  ...
  render() {
    ...
    return (
      <div className="pane-settings">
        ...
        />
        <Help>Give your keyboard a name!</Help>
        <div style={{ height: '0.5rem' }} />
        ...
        />
        <Help>Name to list in C files as copyright owner</Help>
        <div style={{ height: '0.5rem' }} />
        ...
        />
        <Help>Unique 4-digit Hex code for vendor</Help>
        <div style={{ height: '0.5rem' }} />
        ...
        />
        <Help>Unique 4-digit Hex code for product</Help>
        <div style={{ height: '0.5rem' }} />
        ...
        />
        <Help>4-digit Hex code for version</Help>
        <div style={{ height: '0.5rem' }} />
        ...
        />
        <Help>Who makes this keyboard</Help>
        <div style={{ height: '0.5rem' }} />
        ...
        <select
          ...
          onChange={(e) =>
            keyboard.setSetting('switchType', parseInt(e.target.value))
          }
        >
        ...
        <Help>What kind of switch footprint to use on the PCB</Help>
        <div style={{ height: '0.5rem' }} />
        <h2 style={{ width: '8rem', marginRight: '0.8rem' }}>WS2812 LEDs</h2>
        <div
          style={{ width: '8rem', display: 'inline-block', textAlign: 'left' }}
        >
          <NumberBox
            style={{ width: '3.5rem' }}
            min={0}
        ...
        <Help>The number of WS2812 LEDs, if any.</Help>
        <div style={{ height: '0.5rem' }} />
        <h2 style={{ width: '8rem', marginRight: '0.8rem' }}>
          Backlight Levels
        </h2>
        ...
        <Help>The number of backlight levels.</Help>
