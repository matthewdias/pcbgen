export default `  (module Capacitor_SMD:C_0805_2012Metric_Pad1.15x1.40mm_HandSolder (layer B.Cu) (tedit 5B36C52B) (tstamp <%= data.tstamp %>)
    ...
    (fp_text value 22pF (at 0 -1.65 <%= data.rotation %>) (layer B.Fab)
      (effects (font (size 1 1) (thickness 0.15)) (justify mirror))
    )
